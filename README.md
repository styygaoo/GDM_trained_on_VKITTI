This repo is modified from the GuidedDecoding: https://github.com/mic-rud/GuidedDecoding, which additionally adds some functions to train the model on the dataset vkitti.
